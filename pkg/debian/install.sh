...
: "${ARCHIVEBOX_WHEEL_URL:?missing ARCHIVEBOX_WHEEL_URL in $ARCHIVEBOX_PACKAGE_ENV}"
: "${ARCHIVEBOX_WHEEL_SHA256:?missing ARCHIVEBOX_WHEEL_SHA256 in $ARCHIVEBOX_PACKAGE_ENV}"
ARCHIVEBOX_PIP_SPEC="archivebox @ ${ARCHIVEBOX_WHEEL_URL}#sha256=${ARCHIVEBOX_WHEEL_SHA256}"
